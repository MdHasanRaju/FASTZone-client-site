    ...
    <Box style={footerBg}>
      <Container>
        <Grid container spacing={2}>
          <Grid item lg={3} md={3} sm={3} xs={12}>
            <Typography variant="h6" sx={{ textAlign: "left" }}>
              ...
              <Typography
                component="span"
                variant="h6"
                sx={{ color: "deepSkyBlue", fontWeight: 900 }}
              >
                {" "}
                FASTZone
              </Typography>
          ...
          <Grid item lg={3} md={3} sm={3} xs={12} sx={{ textAlign: "left" }}>
            ...
            <Typography component="div" variant="subtitle1" sx={{ pb: 2 }}>
              <i className="fas fa-chevron-right"></i> Alfa Romeo
            </Typography>
            <Typography component="div" variant="subtitle1" sx={{ pb: 2 }}>
              <i className="fas fa-chevron-right"></i> lotus Evora
            </Typography>
            <Typography component="div" variant="subtitle1" sx={{ pb: 2 }}>
              <i className="fas fa-chevron-right"></i> Ferrari
            </Typography>
            <Typography component="div" variant="subtitle1" sx={{ pb: 2 }}>
              <i className="fas fa-chevron-right"></i> BMW Series
            </Typography>
            <Typography component="div" variant="subtitle1" sx={{ pb: 2 }}>
              <i className="fas fa-chevron-right"></i> Mercedes
            </Typography>
          </Grid>
          <Grid item lg={3} md={3} sm={3} xs={12} sx={{ textAlign: "left" }}>
            <Typography variant="h6">CATEGORIES</Typography>
            <Typography component="div" variant="subtitle1" sx={{ pb: 2 }}>
              <i className="fas fa-chevron-right"></i> Crossovers
            </Typography>
            <Typography component="div" variant="subtitle1" sx={{ pb: 2 }}>
              <i className="fas fa-chevron-right"></i> Hybrid SUVs
            </Typography>
            <Typography component="div" variant="subtitle1" sx={{ pb: 2 }}>
              <i className="fas fa-chevron-right"></i> Sports Cars
            </Typography>
            <Typography component="div" variant="subtitle1" sx={{ pb: 2 }}>
              <i className="fas fa-chevron-right"></i> Sports Cars
            </Typography>
            <Typography component="div" variant="subtitle1" sx={{ pb: 2 }}>
              <i className="fas fa-chevron-right"></i> Hybrid Cars
            </Typography>
          </Grid>
          <Grid item lg={3} md={3} sm={3} xs={12} sx={{ textAlign: "left" }}>
        ...
        <Box>
          <Divider></Divider>
          <Box
            sx={{ display: { md: "flex", sm:'flex', lg:'flex' },flexWrap:'wrap', justifyContent: "space-between" }}
          >
            <p className="fw-bolder">© Website 2021 | All Rights Reserved</p>
            <Box>
              <Typography component="small" sx={{ ml: 2 }}>
                Privacy
              </Typography>
              <Typography component="small" sx={{ ml: 2 }}>
                Terms
